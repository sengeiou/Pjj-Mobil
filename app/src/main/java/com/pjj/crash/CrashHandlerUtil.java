...
import static com.pjj.PjjApplication.application;
...
public class CrashHandlerUtil implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (!handleException(ex) && mDefaultHandler != null) {
            ...
            /*Intent intent = new Intent(application.getApplicationContext(), UnPlayActivity.class);
    ...
    private boolean handleException(final Throwable throwable) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                Toast.makeText(application, crashTip, Toast.LENGTH_LONG).show();
                Looper.loop();
            }
        }.start();
        //收集设备参数信息
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            if (pi != null) {
                ...
                infos.put("errorTime", DateUtils.getSfs(new Date()));
            }
        ...
        for (Field field : fields) {
            try {
                ...
                Log.e("TAG1", field.getName() + " : " + field.get(null));
            } catch (Exception e) {
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        Log.e(TAG, "saveCrashInfo2File: " + crashInfo);
        FileUtils.saveStringFile(PjjApplication.App_Path + "/crash.txt", crashInfo);
        return crashInfo;
    }
}
