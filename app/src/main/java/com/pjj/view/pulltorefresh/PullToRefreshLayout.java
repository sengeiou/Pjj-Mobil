package com.pjj.view.pulltorefresh;
...
import com.pjj.R;
import com.pjj.utils.DisplayUtil;
import com.pjj.view.pulltorefresh.view.FooterView;
import com.pjj.view.pulltorefresh.view.HeadRefreshView;
import com.pjj.view.pulltorefresh.view.HeadView;
import com.pjj.view.pulltorefresh.view.LoadMoreView;
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (canLoadMore) {
                    ...
                    Log.e("TAG_Pull", getId() + " onInterceptTouchEvent: canChildScrollDown=" + canChildScrollDown + ", dy=" + dy + ", mTouchSlope=" + mTouchSlope + "");
