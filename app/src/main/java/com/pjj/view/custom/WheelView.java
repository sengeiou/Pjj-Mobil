...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        mPaint.setTextSize(ViewUtils.getFDp(R.dimen.sp_14));
        ...
        int color = ViewUtils.getColor(R.color.color_theme);
        selectPaint.setColor(color);
        selectPaint.setTextSize(ViewUtils.getFDp(R.dimen.sp_14));
    ...
    public void setBackground(Drawable background) {
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                int q = itemHeight *SHOW_SIZE;
                int width = getWidth();
                canvas.drawLine(0, q, width, q, centerLinePaint);
                canvas.drawLine(0, itemHeight+q, width, itemHeight +q, centerLinePaint);
            }
