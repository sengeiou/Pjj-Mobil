...
public class SwipeMenu extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //Log.e("TAG", "onMeasure: " + width + ", " + child.getMeasuredHeight() + ", " + child.getMeasuredWidth());
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            if (i == 0) {
                ...
                child.layout(getMeasuredWidth(), 0, getMeasuredWidth() + child.getMeasuredWidth(), child.getMeasuredHeight());
            }
        }
    }
}
